let resumeData = {
    ...
    "name": "Íñigo Muñoz",
    "role": "Backend Developer | Node.js & API Architect",
    "roleDescription": " Especializado en desarrollo backend con Node.js. Apasionado por construir APIs robustas, eficientes y bien documentadas.",
    "socialLinks":[
        {
          "name":"linkedin",
          "url":"https://www.linkedin.com/in/imjdev/",
        ...
        {
          "name":"cv",
          "url":"https://docs.google.com/document/d/1ve_65A3quOy9QgGNIQXAGegwxs14btN1/edit?usp=sharing&ouid=115605101214033399566&rtpof=true&sd=true",
          "className":"fa fa-file-o"
        }
      ],
    "aboutme":"Desarrollador backend centrado en Node.js, Express y MongoDB. Con experiencia en arquitectura de APIs REST, autenticación segura con JWT, despliegues escalables y automatización de procesos. Firme defensor de las buenas prácticas, el testing y la mejora continua. Además de programar, disfruto con la calistenia y la exploración de nuevas herramientas tecnológicas.",
    ...
    "education":[
      {
        ...
        "MonthOfPassing":"Apr",
        "YearOfPassing":"2022",
        "Achievements":"Bootcamp intensivo de desarrollo web de 9 semanas. Adquisición de altas capacidades para la creación de páginas web desde el entorno Backend y desde el entorno Frontend. Realización de proyectos de alto rendimiento. Tecnologias, JavaScript(ES6), MongoDB, Express, NodeJS, HTML, CSS, React. Otras tecnologías: Git, Postman, Trello, Stripe, Heroku, Netlify",
      },
    ],
    "work":[
        {
          "CompanyName": "IAGT 'Amazing Software'",
          "specialization": "Backend Developer & API Lead",
          "MonthOfEnter": "Apr",
          "MonthOfLeaving": "Now",
          "YearOfLeaving": "2023",
    ...
    "skills":[ 
      ...
      { "skillname": "Resolución de problemas complejos" },
      { "skillname": "Comunicación técnica" },
      { "skillname": "Colaboración interdisciplinar" },
      { "skillname": "Gestión del tiempo" },
      { "skillname": "Adaptabilidad a nuevas tecnologías" },
      { "skillname": "Atención al detalle" },
      { "skillname": "Documentación de APIs" }
